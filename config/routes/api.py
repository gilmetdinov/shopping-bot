...
class ApiRoutes(Enum):
    ...
    get_wallet = '/api/telegram/get-wallet'
    ...
    get_verif_order_cache = '/api/telegram/get-verif-order-cache'
    update_verif_order_cache = '/api/telegram/update-verif-order-cache'
