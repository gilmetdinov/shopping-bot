...
class ApiClient:
    ...
    async def get_payment_address(self, chat_id, currency):
        return await self.__sender.send_request(self.routes.get_payment_address.value,
                                                request_type='post',
    ...
    async def get_order_cache(self, chat_id):
        return await self.__sender.send_request(self.routes.get_order_cache.value,
                                                request_type='post',
                                                data=json.dumps({'chat_id': chat_id}))

    async def update_order_cache(self, chat_id, order_data):
        return await self.__sender.send_request(self.routes.update_order_cache.value,
                                                request_type='post',
                                                data=json.dumps({'chat_id': chat_id,
