...
from aiogram.utils.keyboard import ReplyKeyboardBuilder, MAX_WIDTH, InlineKeyboardBuilder
...
class KeyboardBuilder:
    ...
    def add_row(self, items, row_width=MAX_WIDTH):
...
class InlineBuilder:
    ...
    def add_row(self, items: dict, row_width=MAX_WIDTH):
