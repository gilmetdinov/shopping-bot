...
from bot.handler.services import ListService
...
class ListProcess(AbstractProcess):
    ...
    def __init__(self, api, router):
        ...
        self.service = ListService(api=api)
